...
import rxpattern.internal.Util.printCode as p;
...
@:asserts class PrintRangeSpec {
    ...
    public function printRanges1() {
        ...
        asserts.assert( printRanges(rs).get() == '[${p(0x305)}-${p(0x374)}]' );
        #if js
        var rg = new Regenerate().addRange(0x305, 0x374);
        asserts.assert( rg.toString() == printRanges(rs).get() );
        #end
        return asserts.done();
    }
    ...
    public function printRanges3() {
        ...
        asserts.assert( printRanges(rs).get() == '[A-HZa]' );
        #if js
    ...
    public function printRanges4() {
        ...
        asserts.assert( printRanges(rs).get() == '[ !#/\\]' );
    ...
    public function allAstralCodePoints() {
        ...
        asserts.assert( 
            printRanges(rs).get() == '[${p(0xD800)}-${p(0xDBFF)}][${p(0xDC00)}-${p(0xDFFF)}]'
        );
    ...
    public function allUnicodeCodePoints() {
        ...
        asserts.assert(
            printRanges(rs).get() == '[$NUL-${p(0xD7FF)}${p(0xE000)}-${p(0xFFFF)}]|[${p(0xD800)}-${p(0xDBFF)}][${p(0xDC00)}-${p(0xDFFF)}]|[${p(0xD800)}-${p(0xDBFF)}](?![${p(0xDC00)}-${p(0xDFFF)}])|(?:[^${p(0xD800)}-${p(0xDBFF)}]|^)[${p(0xDC00)}-${p(0xDFFF)}]'
        );
    ...
    public function testRange_rxpatternComplement() {
        ...
        rs.add('l'.code);
        rs.add('o'.code);
        asserts.assert( printRanges(rs).get() == '[ehlo]' );
        ...
        asserts.assert( rg.toString() == printRanges(rs).get() );
        asserts.assert( rg1.toString() == printRanges(rs1).get() );
        #end
